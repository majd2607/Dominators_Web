...
$art=new eventC();
                  $liste=$art->Trieventdate();
                  foreach($liste as $aux) {?>
				  <article class="mb-5 my-4">
            <div class="container px-4 px-lg-10">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
					<img class="img-fluid " width="700" height="400"; src="assets/img/<?php echo $aux["image"];?>"   alt="image"></a>
                        <h2 class="fst-italic"  > <p class="text-xs font-weight-bold mb-0"><?php echo $aux["nomE"];?></h2>
		...
		<tr class="table-danger">
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $aux["date_deb_event"];?></p>
        
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $aux["date_fin_event"];?></p>
                      </td>
					  <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $aux["lieuE"];?></p>
                      </td>
                        </tbody>
                        </table>
