...
<body>
        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          ...
          <h1><B class="mb-0 bread" >Afficher un commentaire</B>
          </div>
        </div>
      </div>
    </div>
    <button type="submit"  class="btn btn-outline-secondary">
    <span class="screen-reader-text"><a href="ajouter_commentaire.php">Ajouter un Commentaire</a></span>
</button>
<div class="my-2">
<br>
<button type="submit"  class="btn btn-outline-secondary">
    <span class="screen-reader-text"><a href="sortComClient.php">tri des commentaires</a></span>
</button>
</br>
</div>
...
<div class="container px-4 px-lg-5">
            ...
            $Art=new commentairesC();
                        $liste=$Art-> afficherCom();
                       // $listecat=$Art->TriCommentaires();
        ...
        <tbody>
         ...
         <tr class="table-danger">
		    					...
		    					<td><?php echo ' '. $aux["text"]; ?></td>
              
		    						<td><?php echo ' '. $aux["date_commentaire"]; ?></td>
                    <td>

                    <td>
				<button class="btn btn-primary" ><a href="modifierComClient.php?idCom=<?php echo $aux['idCom']; ?>" class="text-light">Update</a></button> 
                        </td>
                        <td>
				<button class="btn btn-danger"><a  onclick="return confirm('vous êtes sûr ?')" href="deletecom.php?idCom=<?php echo $aux['idCom']; ?>" class="text-light">Delete</a></button>
			</td>
                        </td>
