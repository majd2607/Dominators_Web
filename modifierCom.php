            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left">
							<div class="logo-name">
									 <a href="index.html"> <h1>Commentaires</h1> 
...
<!-- script-for sticky-nav -->
    ...
    <button class="btn btn-primary"><a href="afficherListeCommentaire.php" class="text-light">Retour à la liste des Commentaires</a></button>
    <hr>
